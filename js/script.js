window.onload = function () {
	...
	new Slider({
        ...
        auto: true,	// Автоперелистование слайдов
        rate: 2000	// Скорость автоперелистования
    });
}
...
function Slider(obj) {
    ...
    this.rate = obj.rate || 1000;	// Задаем скорость перелистования| указаная в объекте Slider или 1000 по умолчанию
